...
bool BitmapClass::Render(ID3D11DeviceContext* deviceContext, int positionX, int positionY, int width, int height)
{
	...
	if(!UpdateBuffers(deviceContext, positionX, positionY, width, height))
	{
		return false;
	}
...
bool BitmapClass::UpdateBuffers(ID3D11DeviceContext* deviceContext, int positionX, int positionY, int width, int height)
{
	...
	vertices[1].texture = XMFLOAT2(w_ratio, h_ratio);

	vertices[2].position = XMFLOAT3(left, bottom, 0.0f);  // Bottom left.
	vertices[2].texture = XMFLOAT2(0.0f, h_ratio);
	...
	vertices[4].texture = XMFLOAT2(w_ratio, 0.0f);

	vertices[5].position = XMFLOAT3(right, bottom, 0.0f);  // Bottom right.
	vertices[5].texture = XMFLOAT2(w_ratio, h_ratio);
